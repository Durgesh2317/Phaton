...
const CheckoutPayment = ({ onBack, onNext, onClose }) => {
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 text-sm focus:ring-2 focus:ring-gray-800 focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">
          ...
          <div className="lg:hidden mb-6">
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-400">
              ...
              <button
                onClick={onNext}
                className="w-full bg-gray-800 text-white py-3 mt-4 rounded-md hover:bg-gray-700 transition"
              >
                Continue to Payment
              </button>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
            {getCurrentItems().map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  <h4 className="text-sm font-medium text-gray-900 mb-3 h-24">
                    {item.name}
                  </h4>

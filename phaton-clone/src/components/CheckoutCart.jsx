...
const CheckoutCart = ({ onNext, onClose }) => {
  ...
  <div className="flex items-center justify-between flex-wrap">
    {["Cart", "Information", "Payment", "Confirmation"].map((step, i) => {
      ...
      return (
        <div
          key={i}
          className="flex items-center space-x-2 w-full sm:w-auto sm:mb-0"
        >
          <div className={`flex items-center justify-center w-8 h-8 mt-2 mb-2 rounded-full text-sm ${circleClasses}`}>
            {i === 0 ? "🛒" : i === 1 ? "📧" : i === 2 ? "💳" : "✓"}
          </div>
        ...
        <div className="flex-1 flex flex-col">
          <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-6 mb-8">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Format: PDF + EPUB</p>
          ...
          <div className="lg:hidden mb-6">
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-400">
              ...
              <button
                onClick={onNext}
                className="w-full bg-gray-800 text-white py-3 px-4 rounded-md font-medium mt-6 hover:bg-gray-700 transition-colors"
              >

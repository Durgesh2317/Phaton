  ...
  return (
    <section className="max-w-7xl mx-auto px-4 lg:px-6 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-lavender-2 rounded-2xl p-8 md:p-10 flex flex-col justify-between min-h-[460px] 
          ...
          <p className="text-3xl p-4 tracking-[0.35em] text-gray-600 mt-8 uppercase">
            just for you
          </p>
        </div>

        <div className="grid gap-6">
          <div className="rounded-2xl overflow-hidden w-[390px] h-[360px] group transition-transform duration-500 ease-in-out hover:scale-105 hover:shadow-xl">
            <Img
          ...
          <div className="rounded-2xl bg-lavender min-h-[310px] p-10 grid place-items-center
                          transition-transform duration-500 ease-in-out hover:scale-105 hover:shadow-xl">
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-semibold leading-snug">Turn</p>
              <p className="text-3xl md:text-4xl font-semibold leading-snug">Ideas</p>
              <p className="text-3xl md:text-4xl font-semibold leading-snug">Digital</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-6 h-[220px]">
            <div className="rounded-2xl bg-lavender-2 p-6 md:p-8 grid place-items-center
              ...
              <div className="text-center space-y-1">
                <p className="text-2xl md:text-3xl font-semibold">Create</p>
                <p className="text-2xl md:text-3xl font-semibold">Your</p>
                <p className="text-2xl md:text-3xl font-semibold">Future</p>
              </div>
            </div>
